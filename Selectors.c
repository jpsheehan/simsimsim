...
bool collidedSelector(Organism *org, Simulation *sim) { return org->didCollide; }

bool hasEnoughEnergySelector(Organism *org, Simulation *sim) { return org->energyLevel > 0.7f; }
...
bool triangleSelector(Organism *org, Simulation *sim) { return (org->pos.x >= org->pos.y); }

bool leftSelector(Organism *org, Simulation *sim) { return org->pos.x < sim->size.w * 0.2; }
bool rightSelector(Organism *org, Simulation *sim) { return org->pos.x > sim->size.w * 0.8; }
